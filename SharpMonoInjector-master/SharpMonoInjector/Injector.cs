...
namespace SharpMonoInjector
{
    ...
    {
        static private string mono_get_root_domain = "mono_get_root_domain";
  
        static private string mono_thread_attach = "mono_thread_attach";
      
        static private string mono_image_open_from_data = "mono_image_open_from_data";
        
        static private string mono_assembly_load_from_full = "mono_assembly_load_from_full";
      
        static private string mono_assembly_get_image = "mono_assembly_get_image";
       
        static private string mono_class_from_name = "mono_class_from_name";
        
        static private string mono_class_get_method_from_name = "mono_class_get_method_from_name";
      
        static private string mono_runtime_invoke = "mono_runtime_invoke";
       
        static private string mono_assembly_close = "mono_assembly_close";
       
        static private string mono_image_strerror = "mono_image_strerror";
       
        static private string mono_object_get_class = "mono_object_get_class";
      
        static private string mono_class_get_name = "mono_class_get_name";

        private Dictionary<string, IntPtr> Exports = new Dictionary<string, IntPtr>
        {
